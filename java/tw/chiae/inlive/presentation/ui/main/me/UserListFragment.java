...
/**
 *
 * Created by huanzhang on 2016/4/18.
 */
public class UserListFragment extends BaseFragment implements IUserList {
    ...
    public static UserListFragment newInstance(String uid, int key,boolean showOnline) {
    ...
    public class StarUserListHolder extends SimpleRecyclerHolder<AnchorSummary> {
        ...
        public void displayData(final AnchorSummary data) {
            ...
            if(data.getIs_attention()==AnchorSummary.IS_ATTENTION){
                if (data.getIs_attention()== UserInfo.IS_ATTENTION){
