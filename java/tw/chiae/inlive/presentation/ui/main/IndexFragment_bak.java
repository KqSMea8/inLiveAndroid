...
public class IndexFragment_bak extends BaseFragment {
    ...
    public static IndexFragment_bak newInstance() {
        return new IndexFragment_bak();
    }
...
//        popuViewPager.setCurrentItem(1);
    ...
    private static class UIHandler extends Handler {
        private final WeakReference<IndexFragment_bak> mActivity;

        public UIHandler(IndexFragment_bak activity) {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            IndexFragment_bak activity = mActivity.get();
            if (activity != null) {
                switch (msg.what) {
                    case UNREAD:
