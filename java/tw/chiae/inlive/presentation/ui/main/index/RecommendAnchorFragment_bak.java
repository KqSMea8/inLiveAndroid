 ...
 * @since 1.0.0
 */
public class RecommendAnchorFragment_bak extends BaseFragment implements RecommendInterface, GoPrivateRoomInterface {
    ...
    public static RecommendAnchorFragment_bak newInstance() {
        return new RecommendAnchorFragment_bak();
    }
...
//        MobclickAgent.onPageStart("主页-最新");
    ...
    public void showPrivateLimit(PrivateLimitBean bean) {
        ...
        if (bean.getCome() == 0 && bean.getPtid() != 0) {
            ...
            goPrivateRoom.setGoPrivateRoomInterface(RecommendAnchorFragment_bak.this);
