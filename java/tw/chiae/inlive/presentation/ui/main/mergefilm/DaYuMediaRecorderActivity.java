 ...
 */
public class DaYuMediaRecorderActivity extends AppCompatActivity implements MediaRecorderBase.OnErrorListener, OnClickListener, MediaRecorderBase.OnPreparedListener,
    ...
    public static Intent createIntent(Context context, String videoUrl, String lrcUrl, int userid, String uploadUrl, String extraInfo) {
        //_starID = starID;
        Intent it = new Intent(context, DaYuMediaRecorderActivity.class);
    ...
    private String getMVPath() {
        String lrcPath = getIntent().getStringExtra(VEDIOURL);
...
//        recording_state = RECORDING_LOADING_STATE;
    ...
    private void initVideoViewMerge() {
        final int w = DeviceUtils.getScreenWidth(this);
        RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) mTestMergeVideo.getLayoutParams();
...
//                        startRecord();
    ...
    private static class myHandler extends Handler {
        ...
        DaYuMediaRecorderActivity activity;
        public myHandler(DaYuMediaRecorderActivity daYuMediaRecorderActivity) {
            this.activity = daYuMediaRecorderActivity;
        }
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case TIME_SEND_FOUR:
                    ...
                    break;
                case TIME_SEND_TWO:
                    activity.mVideoView.seekTo(activity.mMediaObject.getDuration());
                    activity.startAnimImg.setImageResource(R.drawable.second002);
                    break;
                case TIME_SEND_THREE:
                    activity.startAnimImg.setImageResource(R.drawable.second001);
                    break;
            }
...
//            mTvResult.setText(message);
    ...
    private void showErrorDialog(String errormsg) {
        ...
        builder.setPositiveButton(getString(R.string.commit), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                DaYuMediaRecorderActivity.this.finish();
            }
        });
        builder.show();
    }
