 ...
 * @author yixia.com
 */
public class DaYuMediaRecorderSystem extends MediaRecorderBase implements MediaRecorder.OnErrorListener {
    ...
    public DaYuMediaRecorderSystem(Context context) {
   ...
   /*     int orientation_result;
    ...
    protected void concatVideoParts() {
        ...
        for (int i = 0, j = mMediaObject.getMedaParts().size(); i < j; i++) {
            ...
            //transcodingPart();
            Log.i("RayTest", "concatVideoParts i: "+i+" "+ mMediaObject.getPart(i).mediaPath);
            String oldPath = mMediaObject.getPart(i).mediaPath;
