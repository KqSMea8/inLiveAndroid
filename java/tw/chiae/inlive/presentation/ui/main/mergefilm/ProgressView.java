...
public class ProgressView extends View {
    ...
    private void init() {
        ...
        mProgressPaint.setColor(getResources().getColor(R.color.camera_theme_selected_bgcolor));
        ...
        mThreePaint.setColor(getResources().getColor(R.color.camera_theme_selected_bgcolor));
