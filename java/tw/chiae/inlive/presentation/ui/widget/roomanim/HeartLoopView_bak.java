...
public class HeartLoopView_bak extends RelativeLayout {
    ...
    public HeartLoopView_bak(Context context) {
        super(context);
        if (isInEditMode()) {
            return;
        }
    ...
    public HeartLoopView_bak(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) {
            return;
        }
...
/*    private Handler handler = new Handler() {
    ...
    private static class MsgHandler extends Handler {
        ...
        private WeakReference<HeartLoopView_bak> HeartView;

        public MsgHandler(HeartLoopView_bak view) {
            HeartView = new WeakReference<HeartLoopView_bak>(view);
        }
        ...
        public void handleMessage(Message msg) {
            if(HeartView==null)
                return;
            HeartLoopView_bak view = HeartView.get();
            switch (msg.what) {
                case 1:
                    view.playAllAnim();
                    break;
