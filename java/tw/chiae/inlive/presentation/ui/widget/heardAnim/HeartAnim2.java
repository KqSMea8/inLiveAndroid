 ...
 */
public class    HeartAnim2 extends View {

    public static int[] HEART_COLORS = new int[]{
            R.color.md_red_500,
    ...
    public HeartAnim2(Context context) {
        super(context);
        init();
    }

    public HeartAnim2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public HeartAnim2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//            L.v(false, VIEW_LOG_TAG, "pos[0]:" + pos[0] + "   pos[1]:" + pos[1]);
            ...
            L.v(false, VIEW_LOG_TAG, "alpha:" + love.getAlpha() + "   rate:" + love.getRate());
...
//        path.reset();
    ...
    private void builderLoveFromResource() {
