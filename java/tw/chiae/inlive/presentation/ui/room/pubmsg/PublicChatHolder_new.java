 ...
 * Recycle的viewholder
 */
public class PublicChatHolder_new extends SimpleRecyclerHolder<RoomPublicMsg>  implements PublicChatHolderCallback {
...
//    private final ImageView ivPublicLevel;
   ...
   /* private final View vSpace2;
    ...
    public PublicChatHolder_new(View itemView, Context context) {
        super(itemView);
    ...
    public void displayData(final RoomPublicMsg data) {
        ...
        if (data instanceof UserPublicMsg) {
          /*  iv_idICon.setVisibility(View.VISIBLE);
            ...
            tvPublicContent.setText(buildUserChatSequence((UserPublicMsg) data));
