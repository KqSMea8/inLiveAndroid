...
@SuppressLint("NewApi")
public class MsgListRoomAdapter extends BaseAdapter {

    private static final String TAG = "MsgListRoomAdapter";
    ...
    public MsgListRoomAdapter(Context context, String targetId, String appKey,
        ...
        if(mConv==null){
            Log.i("RayTest","mConv null "+mTargetId);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Log.i("RayTest","fromUser:"+msg.getFromUser().getUserID()+" "+msg.getFromUser().getDisplayName());
        ...
        if (holder.headIcon != null) {
            ...
            if (userInfo != null && !TextUtils.isEmpty(userInfo.getAvatar())) {
                Log.i("RayTest","显示头像:"+userInfo.getAvatar());
                userInfo.getAvatarBitmap(new GetAvatarBitmapCallback() {
                    @Override
                    public void gotResult(int status, String desc, Bitmap bitmap) {
                        if (status == 0) {
