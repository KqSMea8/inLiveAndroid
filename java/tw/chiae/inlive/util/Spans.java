...
import tw.chiae.inlive.presentation.ui.room.pubmsg.NameImageSpan;
...
public final class Spans {
    ...
    public static CharSequence createVipSpan(NameImageSpan nameImageSpan) {
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("level");
        spannableStringBuilder.setSpan(nameImageSpan,0,"level".length(),Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
